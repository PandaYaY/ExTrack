...
public record CheckInfoDataDto(
    [property: JsonPropertyName("json")]
    CheckInfoDataJsonDto JsonData,
    [property: JsonPropertyName("html")]
    string HtmlData);

public record CheckInfoDataJsonDto(
    ...
    List<ItemDto> Items,
    [property: JsonPropertyName("nds10")]
    long Nds10,
    [property: JsonPropertyName("nds18")]
    long Nds18,
    [property: JsonPropertyName("fnsUrl")]
    string FnsUrl,
...
public record ItemDto(
    ...
    long Sum,
    [property: JsonPropertyName("nds")]
    long Nds,
    [property: JsonPropertyName("ndsSum")]
    long NdsSum,
...
public record RequestInfoDto(
    [property: JsonPropertyName("qrurl")]
    string QrUrl,
    [property: JsonPropertyName("qrfile")]
    string QrFileInfo,
    [property: JsonPropertyName("qrraw")]
    string QrRaw,
    [property: JsonPropertyName("manual")]
    RequestDataDto Input);
